...
from monApp.views import CategorieListView, CatDetailView, CategorieCreateView, CategorieUpdateView, CategorieDeleteView
...
class CategorieUrlsTest(TestCase):
    ...
    def test_categorie_list_url_is_resolved(self):
        ...
        self.assertEqual(resolve(url).view_name, 'list_categories')
    ...
    def test_categorie_detail_url_is_resolved(self):
        ...
        self.assertEqual(resolve(url).func.view_class, CatDetailView)
