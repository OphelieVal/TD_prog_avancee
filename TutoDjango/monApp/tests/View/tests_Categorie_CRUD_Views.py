...
class CategorieCreateViewTest(TestCase):
    ...
    def test_categorie_create_view_get(self):
        ...
        self.assertTemplateUsed(response, 'create_categorie.html')
...
class CategorieDetailViewTest(TestCase):
    ...
    def test_categorie_detail_view(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'detail_categorie.html')
...
class CategorieUpdateViewTest(TestCase):
    ...
    def test_categorie_update_view_get(self):
        response = self.client.get(reverse('cat_chng', args=[self.ctgr.idCat]))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'update_categorie.html')
    ...
    def test_update_view_post_valid(self):
        ...
        response = self.client.post(reverse('cat_chng', args=[self.ctgr.idCat]), data)
...
class CategorieDeleteViewTest(TestCase):
    ...
    def test_categorie_delete_view_get(self):
        response = self.client.get(reverse('cat_del', args=[self.ctgr.idCat]))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response, 'delete_categorie.html')
    
    def test_categorie_delete_view_post(self):
        response = self.client.post(reverse('cat_del', args=[self.ctgr.idCat]))
        ...
        self.assertRedirects(response, reverse('list_categories'))